...
By accessing or using the Platform or Services, you acknowledge that you have read, understood, and agree to be bound by these Terms, together with any policies, guidelines, or supplemental terms incorporated herein by reference.
...
#### **6. KYC, AML AND SANCTIONS COMPLIANCE**
...
(d) blockchain network fees;

(e) banking charges; and

(f) any other fees disclosed by zPayments from time to time.
...
(i) rights accrued prior to termination;

(ii) outstanding payment obligations;

(iii) indemnification obligations;

(iv) confidentiality obligations; or

(v) any provision intended to survive termination.
...
#### **34. PROHIBITED BUSINESS CATEGORIES**
...
5. inaccurate instructions; or
6. any other mistake,

zPayments reserves the right to:

(i) reverse the transaction where possible;

(ii) recover funds from future transactions;

(iii) offset amounts owed against any funds otherwise payable to the User; and

(iv) pursue all available legal remedies.
...
#### **37. WITHDRAWAL PROCESSING**

If any transaction fails, Zoth will enable the option to withdraw USDC deposited into the whitelisted wallet within T+7 days after compliance clearance.
